...
st.text("예-민수는 체육대회에서 친구들과 함께 열심히 뛰면서 서로 응원하고 도와주었어요.")
st.text("예-지수는 우리 반 친구들과 함께 과학 프로젝트를 준비하며 많은 시간을 함께 보냈고, 결국 좋은 성과를 거두었어요.")
st.text("예-소라는 새 학기에 전학 온 친구를 반 친구들과 함께 도와주고 학교 생활에 적응할 수 있도록 도왔어요.")
